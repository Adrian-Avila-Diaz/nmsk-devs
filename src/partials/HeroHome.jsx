...
function HeroHome() {
  ...
  return (
    <section className="relative bg-DarkPurple">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4 text-white" data-aos="zoom-y-out">El exotiqueo <br /> <span className="bg-clip-text text-transparent bg-gradient-to-r from-ShockingPink  to-SpringGreen ">NMSK Devs</span></h1>
            <div className="max-w-3xl mx-auto">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                <div>
                  <a className="btn text-[#e9ddff] bg-[#5600ca] hover:bg-[#3c0091] w-full mb-4 sm:w-auto sm:mb-0" href="#0">Start free trial</a>
                </div>
                <div>
                  <a className="btn text-[#003920] bg-[#2ae291] hover:bg-[#2ae292c5] w-full sm:w-auto sm:ml-4" href="#0">Learn more</a>
                </div>
              </div>
            </div>
          </div>
